...
**4** ports are the whole console interface, **3** checks carrying values taken on a console, **0** disagreements, **14** of **18** more verdicts from a cartridge of them agree, **650** tests, **100%** statement and branch coverage, no dependencies
